    ...
    <Modal open={open} header={{ heading: 'Del utkast og gjør klar vedtak' }} onClose={onCancel}>
      <Modal.Body>
        <BodyLong size="small">
          ...
          gjennom hva du foreslår å sende til arrangøren. Bruker ser innhold, bakgrunnsinformasjon og navnet ditt.
        </BodyLong>

        <BodyLong size="small" className="mt-6 mb-6">
          Når brukeren godtar utkastet, så fattes vedtaket. I Deltakeroversikten på nav.no ser arrangøren
