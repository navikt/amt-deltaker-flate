...
export const varighetValgForType = (tiltakstype: Tiltakstype): VarighetValg[] => {
  switch (tiltakstype) {
    case Tiltakstype.ARBFORB: return [
      VarighetValg.TRE_MANEDER,
      VarighetValg.SEKS_MANEDER,
      VarighetValg.TOLV_MANEDER,
    ]
    case Tiltakstype.ARBRRHDAG: return [
      VarighetValg.FIRE_UKER,
      VarighetValg.SEKS_UKER,
      VarighetValg.TOLV_UKER,
    ]
    case Tiltakstype.AVKLARAG: return [
      VarighetValg.FIRE_UKER,
      VarighetValg.ATTE_UKER,
    ]
    case Tiltakstype.INDOPPFAG: return [
      VarighetValg.TRE_MANEDER,
      VarighetValg.SEKS_MANEDER,
    ]
    case Tiltakstype.DIGIOPPARB: return [
      VarighetValg.FIRE_UKER,
    ]
    case Tiltakstype.VASV: return [
      VarighetValg.SEKS_MANEDER,
      VarighetValg.TOLV_MANEDER
    ]
